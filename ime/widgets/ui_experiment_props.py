...
# Form implementation generated from reading ui file 'ime/widgets/ui_experiment_props.ui'
#
...
class Ui_ExperimentPropertyEditor(object):
    def setupUi(self, ExperimentPropertyEditor):
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 500, 385))
        ...
        self.page_5.setGeometry(QtCore.QRect(0, 0, 500, 186))
        self.page_5.setObjectName("page_5")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.page_5)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.accessControlTab = AccessControlTab(self.page_5)
        ...
        self.metadata_tab.setGeometry(QtCore.QRect(0, 0, 500, 385))
