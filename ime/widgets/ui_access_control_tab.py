...
# Form implementation generated from reading ui file 'ime/widgets/ui_access_control_tab.ui'
#
...
class Ui_AccessControlTab(object):
    def setupUi(self, AccessControlTab):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.adminUsersList)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.readGroupsList)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.readUsersList)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.downloadGroupsList)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.downloadUsersList)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.sensitiveGroupsList)
    ...
    def retranslateUi(self, AccessControlTab):
        ...
        self.label_30.setText(_translate("AccessControlTab", "Admin users"))
        self.label_31.setText(_translate("AccessControlTab", "Read groups"))
        self.label_32.setText(_translate("AccessControlTab", "Read users"))
        self.label_33.setText(_translate("AccessControlTab", "Download groups"))
        self.label_34.setText(_translate("AccessControlTab", "Download users"))
        self.label_35.setText(_translate("AccessControlTab", "Sensitive groups"))
