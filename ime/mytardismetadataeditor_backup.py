...
class MyTardisMetadataEditor(QMainWindow):
    def __init__(self):
        ...
        self.ui.datasetTreeWidget.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
        self.ui.datasetTreeWidget.customContextMenuRequested.connect(self.dataestMenuContextTree)
        self.ui.experimentTreeWidget.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
        self.ui.experimentTreeWidget.customContextMenuRequested.connect(self.experimentMenuTreeWidget)
        self.ui.projectTreeWidget.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
