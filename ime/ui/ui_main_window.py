...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.projectTreeWidget = QtWidgets.QTreeWidget(parent=self.splitter_2)
        ...
        self.projectTabProps = QtWidgets.QStackedWidget(parent=self.splitter_2)
        ...
        self.label_55 = QtWidgets.QLabel(parent=self.page_16)
        ...
        self.verticalLayout_9.addWidget(self.label_55, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_56 = QtWidgets.QLabel(parent=self.page_16)
        font = QtGui.QFont()
        ...
        self.label_57 = QtWidgets.QLabel(parent=self.page_16)
        font = QtGui.QFont()
        ...
        self.splitter_3 = QtWidgets.QSplitter(parent=self.experiment_tab)
        self.splitter_3.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter_3.setChildrenCollapsible(False)
        self.splitter_3.setObjectName("splitter_3")
        self.experimentTreeWidget = QtWidgets.QTreeWidget(parent=self.splitter_3)
        ...
        self.experimentTabProps = QtWidgets.QStackedWidget(parent=self.splitter_3)
        ...
        self.label_46 = QtWidgets.QLabel(parent=self.page_13)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_6.addWidget(self.label_46, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_47 = QtWidgets.QLabel(parent=self.page_13)
        font = QtGui.QFont()
        font.setFamily("Noto Sans Display")
        font.setPointSize(17)
        font.setBold(True)
        ...
        self.label_48 = QtWidgets.QLabel(parent=self.page_13)
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(12)
        ...
        self.splitter = QtWidgets.QSplitter(parent=self.dataset_tab)
        ...
        self.datasetTreeWidget = QtWidgets.QTreeWidget(parent=self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.datasetTabProps = QtWidgets.QStackedWidget(parent=self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_49 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_4.addWidget(self.label_49, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_50 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        font = QtGui.QFont()
        font.setFamily("Noto Sans Display")
        font.setPointSize(17)
        font.setBold(True)
        ...
        self.verticalLayout_4.addWidget(self.label_50, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_51 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(12)
        ...
        self.verticalLayout_4.addWidget(self.label_51, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
