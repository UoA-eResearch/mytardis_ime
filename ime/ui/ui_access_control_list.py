...
class Ui_AccessControlList(object):
    def setupUi(self, AccessControlList):
        ...
        self.aclTable = QtWidgets.QTableView(parent=AccessControlList)
        ...
        self.btnAdd = QtWidgets.QPushButton(parent=AccessControlList)
        self.btnAdd.setObjectName("btnAdd")
        self.verticalLayout_2.addWidget(self.btnAdd)
        self.btnDelete = QtWidgets.QPushButton(parent=AccessControlList)
