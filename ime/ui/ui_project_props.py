...
class Ui_ProjectPropertyEditor(object):
    def setupUi(self, ProjectPropertyEditor):
        ...
        self.toolBox_3 = QtWidgets.QToolBox(parent=ProjectPropertyEditor)
        ...
        self.frame_3 = QtWidgets.QFrame(parent=self.page_7)
        ...
        self.projectNameLineEdit = QtWidgets.QLineEdit(parent=self.frame_3)
        self.projectNameLineEdit.setObjectName("projectNameLineEdit")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.projectNameLineEdit)
        ...
        self.projectDescriptionLineEdit = QtWidgets.QPlainTextEdit(parent=self.frame_3)
        self.projectDescriptionLineEdit.setObjectName("projectDescriptionLineEdit")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.projectDescriptionLineEdit)
        self.leadResearcherLabel = QtWidgets.QLabel(parent=self.frame_3)
        self.leadResearcherLabel.setObjectName("leadResearcherLabel")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.leadResearcherLabel)
        self.leadResearcherLineEdit = QtWidgets.QLineEdit(parent=self.frame_3)
        self.leadResearcherLineEdit.setObjectName("leadResearcherLineEdit")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.leadResearcherLineEdit)
        self.identifierList = IdentifierList(parent=self.frame_3)
        self.identifierList.setObjectName("identifierList")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.identifierList)
        ...
        self.accessControlTab = ProjectAccessControlTab(parent=self.page_8)
