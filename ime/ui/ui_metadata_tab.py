...
class Ui_MetadataTab(object):
    def setupUi(self, MetadataTab):
        ...
        self.label_3 = QtWidgets.QLabel(MetadataTab)
        font = QtGui.QFont()
        ...
        self.schemaLabel = QtWidgets.QLabel(MetadataTab)
        self.schemaLabel.setObjectName("schemaLabel")
        self.horizontalLayout.addWidget(self.schemaLabel)
        self.schemaLineEdit = QtWidgets.QLineEdit(MetadataTab)
        ...
        self.add_row_btn = QtWidgets.QPushButton(MetadataTab)
        self.add_row_btn.setObjectName("add_row_btn")
        self.horizontalLayout_3.addWidget(self.add_row_btn)
        self.remove_rows_btn = QtWidgets.QPushButton(MetadataTab)
        ...
        self.label_4 = QtWidgets.QLabel(MetadataTab)
        self.label_4.setObjectName("label_4")
        self.verticalLayout.addWidget(self.label_4)
        self.notes_textedit = QtWidgets.QTextEdit(MetadataTab)
