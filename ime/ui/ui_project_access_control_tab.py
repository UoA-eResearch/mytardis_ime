...
# from PyQt6.QtWidgets import QSizePolicy, QHBoxLayout, QVBoxLayout, QSpacerItem, QPushButton, QTableView, QGridLayout
...
class Ui_ProjectAccessControlTab:
    def setupUi(self, ProjectAccessControlTab):
        ...
        ProjectAccessControlTab.setMinimumSize(400, 500)
