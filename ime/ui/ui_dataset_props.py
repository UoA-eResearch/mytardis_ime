...
class Ui_DatasetProps(object):
    def setupUi(self, DatasetProps):
        ...
        self.page.setGeometry(QRect(0, 0, 548, 528))
        ...
        self.page_2.setGeometry(QRect(0, 0, 548, 516))
        ...
        self.toolBox.addItem(self.page_2, u"User and group access")
        self.page_3 = MetadataTab()
        self.page_3.setObjectName(u"page_3")
        self.page_3.setGeometry(QRect(0, 0, 548, 516))
        ...
        self.fileinfoDescription.setGeometry(QRect(0, 0, 486, 50))
        ...
        self.page_10.setGeometry(QRect(0, 0, 334, 640))
    ...
    def retranslateUi(self, DatasetProps):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), QCoreApplication.translate("DatasetProps", u"User and group access", None))
