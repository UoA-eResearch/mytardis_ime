...
class Ui_DatasetProps(object):
    def setupUi(self, DatasetProps):
        ...
        self.datasetTabProps = QtWidgets.QStackedWidget(parent=DatasetProps)
        ...
        self.toolBox = QtWidgets.QToolBox(parent=self.datasetProperties)
        ...
        self.datasetNameLineEdit = QtWidgets.QLineEdit(parent=self.page)
        ...
        self.instrumentIDLineEdit = QtWidgets.QLineEdit(parent=self.page)
        ...
        self.identifierList = IdentifierList(parent=self.page)
        ...
        self.accessControlTab = OverridableAccessControlTab(parent=self.page_2)
        ...
        self.toolBox_4 = QtWidgets.QToolBox(parent=self.datafileProperties)
        ...
        self.checkBox_3 = QtWidgets.QCheckBox(parent=self.page_10)
        self.checkBox_3.setObjectName("checkBox_3")
        self.verticalLayout_5.addWidget(self.checkBox_3)
        self.frame_5 = QtWidgets.QFrame(parent=self.page_10)
        ...
        self.tableWidget_23 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_24 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_25 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_26 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_27 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_28 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.tableWidget_29 = QtWidgets.QTableWidget(parent=self.frame_5)
        ...
        self.label_43 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_3.addWidget(self.label_43, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_44 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        font = QtGui.QFont()
        ...
        self.label_45 = QtWidgets.QLabel(parent=self.noDatasetSelectedProps)
        font = QtGui.QFont()
