...
class IngestionMetadata:
    ...
    def _to_yaml(self) -> str:
        ...
        Returns:
            str: A string of the YAML representation of the metadata.
        """
    ...
    def get_files_by_dataset(self, dataset: Dataset) -> List[Datafile]:
        ...
        Args:
            dataset (Dataset): The dataset to look up datafiles for.
        
        Returns:
            List[Datafile]: a list of datafiles that belong to the dataset.
        """
    ...
    def get_datasets_by_experiment(self, exp: Experiment) -> List[Dataset]:
        ...
        Args:
            exp (Experiment): The experiment to look up datasets for.

        Returns:
            List[Dataset]: A list of datasets that belong to the experiment.
        """
    ...
    def get_experiments_by_project(self, proj: Project) -> List[Experiment]:
        ...
        Args:
            proj (Project): The project to look up datasets for.

        Returns:
            List[Experiment]: A list of experiments that belong to the project.
